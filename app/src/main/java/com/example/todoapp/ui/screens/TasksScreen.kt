 ...
 fun ToDoListScreen(viewModel: TaskViewModel){
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "${tasks.filter { !it.taskDone }.size} remaining today",
                color = grey
            )
                ...
                LazyColumn(
                    ...
                    items(
                        ...
                        ToDoItem(
                            ...
                            onCheckChange = {checked-> viewModel.updateTask(task.copy(taskDone = checked))}
    ...
    if(showEditorDialog){
        TaskEditorDialog(
            ...
            onSave ={ newName->
                if(taskToEdit == null){
                    viewModel.addTask(TaskItem(taskName = newName, taskDone = false))
                }else{
